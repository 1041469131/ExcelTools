...
public class BaseExcelService {
    ...
    /**存放Hash密码的行*/
    public   int hashRow =0;
    /**标题行*/
    public   static int TITLE_ROW =1;
    /**隐藏字段行*/
    public   static int HIDDENFIELDHEAD = TITLE_ROW +1;
    /**表头列名*/
    public   static  int COLUMN_ROW = HIDDENFIELDHEAD +1;
    /**数据开始行*/
    public  static  int START_ROW = COLUMN_ROW +1;
     ...
     * @param hashCode
     */
    public   void setHashVal(Sheet sheet,long hashCode){
        Row sheetRow = sheet.getRow(hashRow);
     ...
     * @return
     */
    public   long getHashVal(Sheet sheet){
        Row sheetRow = sheet.getRow(hashRow);
