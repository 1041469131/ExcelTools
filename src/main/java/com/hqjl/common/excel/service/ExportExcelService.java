...
import com.hqjl.common.excel.adapter.IOAdapter;
...
import com.hqjl.common.excel.utils.AdapterUtil;
...
import com.hqjl.common.excel.bean.DataBean;
import com.hqjl.common.excel.bean.FieldBean;
import com.hqjl.common.excel.bean.FieldType;
...
import com.hqjl.common.excel.exception.ExcelVoErrorException;
...
import com.hqjl.common.excel.utils.Message;
...
public class ExportExcelService<T extends BaseExcelVo> extends BaseExcelService {
    ...
    /** 国际化头 */
    protected ILanguage language = new SimpleLanguage();
    ...
    public ExportExcelService(String sheetName,Object data, String[] fields, String title) throws Exception {
    ...
    public ExportExcelService setUseGetterSetter(boolean useGetterSetter){
        this.dataBean.setUseGetterSetter(useGetterSetter);
        return this;
    }
    ...
    public ExportExcelService createData() throws AdapterException, ColumnErrorException {
